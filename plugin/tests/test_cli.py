...
def test_exactly_the_read_verbs_and_the_human_only_verbs_take_a_slug():
    ...
    subcommand carrying --slug. The five read verbs take it as an address
    (#243; `diff` and `blame` joined them in #975, both pure readers that
    stamp nothing). The ten human-only decision verbs take it as a ROUTING flag
