...
def _public_entry_points(sub: str):
    ...
    return [
        ...
        ("latest_world_verdicts",
         lambda: store.latest_world_verdicts(project_dir=sub)),
        ("latest_invalidation_verdicts",
         lambda: store.latest_invalidation_verdicts(project_dir=sub)),
        ("append_world_cure",
         lambda: store.append_world_cure("i-1", "file-exists-ok", "a" * 64,
                                         project_dir=sub)),
        ("append_receipt_cure",
