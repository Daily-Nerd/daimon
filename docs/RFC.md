...
>
> This RFC specifies the retired standalone "persistent AI companion" system. The current component map is [Runtime Architecture](./RUNTIME-ARCHITECTURE.md). The shipped runtime is self-contained and host-agnostic; Honcho and Graphiti are not runtime dependencies.
>
