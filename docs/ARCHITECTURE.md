...
>
> This document describes the **standalone-system architecture**, retired per **[D-008](../research/DECISIONS.md)** (user-approved 2026-06-09). The current authoritative component map is **[RUNTIME-ARCHITECTURE.md](./RUNTIME-ARCHITECTURE.md)**. The shipped runtime remains self-contained and host-agnostic; Honcho and Graphiti are not runtime dependencies.
>
